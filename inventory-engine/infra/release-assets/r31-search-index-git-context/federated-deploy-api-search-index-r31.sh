...
readonly IMAGE_TAG="inventory-api-integrated-r31-search-index-git-context"
...
readonly SOURCE_CONTEXT_URL="https://github.com/cococelgit/LSCInventoryCopartIaaI.git#81b337d2e1ceb4802128cb2d2c73b83df85fb595:inventory-engine"

fail() { printf 'API_R31_SEARCH_GIT_CONTEXT_ERROR: %s\n' "$*" >&2; exit 1; }
