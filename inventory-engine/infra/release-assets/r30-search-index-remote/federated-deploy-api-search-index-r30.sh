...
readonly IMAGE_TAG="inventory-api-integrated-r30-search-index-remote"
...
fail() { printf 'API_R30_SEARCH_REMOTE_ERROR: %s\n' "$*" >&2; exit 1; }
...
[[ "$api_image_after" == "$image_ref" ]] || fail "API image was not updated to r30 remote build"
