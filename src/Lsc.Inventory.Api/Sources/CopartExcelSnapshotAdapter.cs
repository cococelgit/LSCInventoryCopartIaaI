...
public sealed class CopartExcelSnapshotAdapter(IOptions<CopartExcelOptions> options) : ICopartExcelSnapshotAdapter
{
    ...
    private static AuctionVehicle MapRow(IReadOnlyDictionary<string, string?> row)
    {
        ...
        return new AuctionVehicle
        {
            ...
            VehicleType = FirstPresent(Get(row, "Body Style"), Get(row, "Vehicle Type")),
            Color = Get(row, "Color"),
            ...
            {
                BodyStyle = FirstPresent(Get(row, "Body Style"), Get(row, "Vehicle Type")),
            ...
            AdditionalData = new Dictionary<string, JsonElement>
            {
                ...
                ["source_body_style"] = JsonSerializer.SerializeToElement(Get(row, "Body Style")),
