...
readonly IMAGE_TAG="inventory-api-integrated-r27-performance"
...
readonly EXPECTED_API_IMAGE="${REGISTRY_LOGIN_SERVER}/${IMAGE_REPOSITORY}:inventory-api-integrated-r26-run-drive"
...
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-api-r27-performance-root.tar_fa62f76f.gz"
readonly SOURCE_CONTEXT_SHA256="ff46da7da4c37e08ccbd5e1f3bcbec236aeb9990cf5a9f0926f0e15be3eec250"

fail() { printf 'API_R27_PERFORMANCE_DEPLOY_ERROR: %s\n' "$*" >&2; exit 1; }
