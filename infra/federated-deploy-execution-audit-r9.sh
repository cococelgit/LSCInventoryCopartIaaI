...
readonly IMAGE_TAG="execution-audit-r9-isolated-schema"
readonly API_NAME="ca-lsc-inventory-api-prod"
readonly IAAI_JOB_NAME="job-lsc-iaai-pilot-prod"
readonly EXPECTED_CRON="15,45 * * * *"
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-execution-audit-r9.tar_bcce60f0.gz"
readonly SOURCE_CONTEXT_SHA256="7ea9a0dcf25b7bab4151390a4d863d06c1fee2638449dc200be0eb2d440aefc2"
...
[[ "$job_image_before" == *":execution-audit-r8-owned-schema" ]] || fail "Expected audited IAAI r8 image; found: ${job_image_before:-empty}"
...
az containerapp update --resource-group "$RESOURCE_GROUP" --name "$API_NAME" --image "$image_ref" --set-env-vars Persistence__RunMigrations=false --output none
