...
readonly IMAGE_TAG="execution-audit-r6"
readonly API_NAME="ca-lsc-inventory-api-prod"
readonly IAAI_JOB_NAME="job-lsc-iaai-pilot-prod"
readonly EXPECTED_CRON="15,45 * * * *"
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-execution-audit-r6.tar_ce0be77e.gz"
readonly SOURCE_CONTEXT_SHA256="c51c5dc845a053537631d7aa5116d76191f450679eec1c5bf1f8f29586068efd"
...
[[ "$job_image_before" == *":iaai-national-r3-full-backfill" ]] || fail "Expected IAAI r3 image; found: ${job_image_before:-empty}"
