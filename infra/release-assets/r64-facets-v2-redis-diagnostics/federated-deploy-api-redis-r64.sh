#!/usr/bin/env bash
# Adds safe Redis L2 diagnostics and updates only the Inventory API image.
...
readonly IMAGE_TAG="inventory-api-integrated-r64-facets-redis-diagnostics"
...
readonly EXPECTED_API_IMAGE="${REGISTRY_LOGIN_SERVER}/${IMAGE_REPOSITORY}:inventory-api-integrated-r63-facets-redis-shared-cache"
...
readonly SOURCE_CONTEXT_URL="https://github.com/cococelgit/LSCInventoryCopartIaaI.git#615f76d5133906c0e2483a96328b09642d214493"

fail() { printf 'API_R64_FACETS_REDIS_DIAGNOSTICS_ERROR: %s\n' "$*" >&2; exit 1; }
...
[[ "$api_image_after" == "$image_ref" ]] || fail "API image was not updated to r64 diagnostics build"
