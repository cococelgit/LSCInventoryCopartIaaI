...
readonly IMAGE_TAG="execution-audit-r6b-nullsafe"
readonly API_NAME="ca-lsc-inventory-api-prod"
readonly IAAI_JOB_NAME="job-lsc-iaai-pilot-prod"
readonly EXPECTED_CRON="15,45 * * * *"
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-execution-audit-r6b.tar_1a44111a.gz"
readonly SOURCE_CONTEXT_SHA256="1f6ccc858b2b077309e55416234608e92a4fcaf6c1ad0e475446dcd956936a01"
...
[[ "$job_image_before" == *":execution-audit-r6" ]] || fail "Expected audited IAAI r6 image; found: ${job_image_before:-empty}"
