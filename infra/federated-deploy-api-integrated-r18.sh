...
readonly IMAGE_TAG="inventory-api-integrated-r18-platform-lot"
...
readonly EXPECTED_API_IMAGE="${REGISTRY_LOGIN_SERVER}/${IMAGE_REPOSITORY}:inventory-api-integrated-r16"
...
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-integrated-api-r18.tar_0f2937b2.gz"
readonly SOURCE_CONTEXT_SHA256="6e3fc176ec68ee1f1962d3725a016e8aa93417f4dd32e7d8a1a5332ddd425df0"

fail() { printf 'API_R18_DEPLOY_ERROR: %s\n' "$*" >&2; exit 1; }
...
[[ "$api_image_before" == "$EXPECTED_API_IMAGE" ]] || fail "Expected integrated r16 API image; found: ${api_image_before:-empty}"
...
[[ "$api_image_after" == "$image_ref" ]] || fail "API image was not updated to r18"
...
printf 'API_R18_DEPLOY_COMPLETED\n'
