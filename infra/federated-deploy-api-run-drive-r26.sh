#!/usr/bin/env bash
# Builds the integrated Run & Drive API revision and changes only the shared API Container App.
set -Eeuo pipefail
...
readonly IMAGE_TAG="inventory-api-integrated-r26-run-drive"
...
readonly SOURCE_CONTEXT_URL="https://lsc-inv-revi-zyn4tlbw.manus.space/manus-storage/lsc-inventory-engine-api-r26-run-drive-root.tar_55f257b6.gz"
readonly SOURCE_CONTEXT_SHA256="3a68b4ad0979ac44c14e4fbccb90bd59d2038298add7b5d1e50d200756840e38"

fail() { printf 'API_R26_RUN_DRIVE_DEPLOY_ERROR: %s\n' "$*" >&2; exit 1; }
...
[[ "$api_image_after" == "$image_ref" ]] || fail "API image was not updated to r26"
