...
readonly IMAGE_TAG="inventory-api-integrated-r28-search-index"
...
readonly SOURCE_CONTEXT_URL="https://raw.githubusercontent.com/cococelgit/LSCInventoryCopartIaaI/main/inventory-engine/infra/release-assets/r28-search-index/lsc-inventory-engine-api-r28-search-index.tar.gz"
readonly SOURCE_CONTEXT_SHA256="1a5722e48a6eb6f901b3261aead67282dd05d345a425fa5112c151718753ec4a"

fail() { printf 'API_R28_SEARCH_DEPLOY_ERROR: %s\n' "$*" >&2; exit 1; }
...
[[ "$api_image_after" == "$image_ref" ]] || fail "API image was not updated to r27 performance"
